...
describe('ActivityFeed', () => {
  ...
  test('formatTime shows "just now" for recent events', async () => {
    const now = new Date();
    vi.mocked(fetchActivity).mockResolvedValue([
  ...
  test('formatTime shows "Xm ago" for events within an hour', async () => {
    const now = new Date();
    vi.mocked(fetchActivity).mockResolvedValue([
  ...
  test('formatTime shows "Xh ago" for events within a day', async () => {
    const now = new Date();
    vi.mocked(fetchActivity).mockResolvedValue([
  ...
  test('formatTime shows locale date for events older than a day', async () => {
    const now = new Date();
